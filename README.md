...
текст. Спорное и редполитика молча не правятся.
...
2. **Пунктуация.** Запятые (однородные, ССП/СПП, обособления), тире и двоеточие в БСП
   (выбор знака по смыслу), прямая речь, **слова-ловушки** (вряд ли, якобы, будто, ведь,
   как раз, всё-таки — НЕ выделять запятыми).
...
4. **Языковое единообразие.** Собрать разнобой в **языковых формах** (написания имён и
   ...
   и привести к одному канону. Спорное — в «На решение автора», не молча.
...
- **Пунктуация:** обособление определений/обстоятельств/приложений/уточнений; парные знаки
  ...
  тире/двоеточие в БСП **по смыслу**; прямая речь.
...
- **Не правит типографику.** Ёлочки, форма тире, неразрывные пробелы, юникод — не зона
  корректора (правила формализуются без понимания смысла).
...
«Розенталь» — скил для редакторов из семьи **[рИИдактор](https://redaktozavr.ru/rAIdactor?utm_source=skills)**, рассылки про
...
Розенталь идёт **четвёртым**: когда смысл устоялся (Чуковский), факты
проверены (Аграновский) и слоп снят (Слопотрон), наводит норму — орфографию,
пунктуацию, согласование — по уже очищенному тексту. После содержания, до формы.
## Лицензия
